...
function FieldLabel({ children }: { children: React.ReactNode }) {
  return (
    <label className="text-[11px] font-semibold uppercase tracking-[0.16em] text-black/48">
      {children}
    </label>
  );
}
...
const inputClassName =
  "mt-2 w-full rounded-2xl border border-black/12 bg-black/[0.02] px-4 py-3 text-sm text-black outline-none transition focus:border-black/28 focus:bg-white";
    ...
    <div className="page-shell bg-white">
      <main className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 lg:px-8 lg:py-18">
        <Reveal className="grid gap-6 lg:grid-cols-[0.95fr_1.25fr]">
          <section className="rounded-[2rem] border border-[rgba(214,140,40,0.28)] bg-white p-6 shadow-[0_1px_2px_rgba(0,0,0,0.04),0_12px_32px_-16px_rgba(0,0,0,0.12)] sm:p-8">
            ...
            <p className="mt-5 text-sm leading-8 text-black/68 sm:text-[15px]">
            ...
            <div className="mt-6 space-y-3">
              {[
                ...
                <div
                  key={item}
                  className="rounded-2xl border border-black/10 bg-black/[0.02] px-4 py-3 text-sm leading-7 text-black/76"
                >
                  {item}
                </div>
              ))}
          ...
          <form
            ...
            className="rounded-[2rem] border border-black/10 bg-white p-6 shadow-[0_1px_2px_rgba(0,0,0,0.04),0_20px_48px_-24px_rgba(0,0,0,0.16)] sm:p-8"
          >
            <div className="grid gap-8">
              ...
              {error ? (
                <p className="rounded-2xl border border-red-500/30 bg-red-50 px-4 py-3 text-sm text-red-700">
                  {error}
                </p>
              ) : null}
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                <button
                  type="submit"
                  disabled={submitting}
                  className="inline-flex items-center justify-center rounded-sm bg-black px-5 py-3 text-xs font-medium uppercase tracking-[0.18em] text-white transition hover:bg-black/85 disabled:cursor-not-allowed disabled:opacity-60"
                >
